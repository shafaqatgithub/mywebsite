...
const Services = () => {
  return (
    <section className='py-20' id="services">
      ...
      <div className='flex flex-row items-center justify-center mb-6 pb-20' id='projects'>
        <h2 className='font-bold text-4xl text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-pink-600 '>Services</h2>
        <div className='h-1 w-32 border border-orange-600 ml-6 bg-orange-600'></div>
      </div>
        <div className='grid m-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 px-4'>
