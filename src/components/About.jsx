...
const About = () => {
  return (
    <div className='w-full h-[70%] px-6 md:px-20 md:py-44 py-20 flex flex-col items-center' id="about">
      <div className='flex flex-row items-center justify-center mb-6'>
        <h2 className='font-bold text-2xl md:text-4xl text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-pink-600'>About Me</h2>
