...
const Hero = () => {
  return (
    <div className='h-screen w-full flex flex-col items-center justify-center px-10 relative' id="home">
      ...
      <div className='flex flex-row justify-center items-baseline gap-8 mt-10 md:absolute md:bottom-28 md:right-20 md:flex-col'>
        <a href='https://www.linkedin.com/in/shafaqat-arif/' target='_blank' rel='noopener noreferrer' className='text-gray-800 hover:text-blue-600'>
          <FaLinkedin size={20} color='orange'/>
        </a>
        <a href='https://github.com/shafaqatgithub' target='_blank' rel='noopener noreferrer' className='text-gray-800 hover:text-black'>
          <FaGithub size={20} color='orange' />
        </a>
        <a href='https://dribbble.com/Shafaqat_M' target='_blank' rel='noopener noreferrer' className='text-gray-800 hover:text-black'>
          <FaDribbble size={20} color='orange' />
        </a>
      </div>
    </div>
